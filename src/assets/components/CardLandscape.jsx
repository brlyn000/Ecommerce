...
export default function CardLandscape() {
  return (
    <div className="relative overflow-hidden py-20 px-5 sm:px-6 lg:px-24 bg-gradient-to-br from-red-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Image with frame effect */}
          <div className="relative group">
            <div className="absolute -inset-4 bg-gradient-to-r from-sky-400 to-red-600 rounded-2xl opacity-30 group-hover:opacity-50 blur-md transition-all duration-500"></div>
            <img 
            ...
            />
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-red-600 rounded-full opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
          </div>
          ...
          <div className="relative">
            ...
            <h1 className="mb-8 text-3xl font-extrabold text-gray-900 md:text-4xl lg:text-5xl text-center lg:text-left">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-red-600 animate-gradient-x">
                Tentang Kami
              </span>
            </h1>
            ...
            <div className="space-y-6 text-gray-700 text-lg">
              <p className="relative z-10 leading-relaxed">
                <span className="absolute -left-4 top-2 w-2 h-2 bg-red-500 rounded-full"></span>
            ...
            {/* Decorative elements */}
            <div className="hidden lg:block absolute -bottom-12 -right-12 w-40 h-40 bg-gradient-to-r from-sky-300 to-red-400 rounded-full opacity-10"></div>
          </div>
        </div>
      </div>
    </div>
